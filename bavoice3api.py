...
WS_URL = "wss://api.openai.com/v1/realtime?model=gpt-4o-mini-realtime-preview-2024-12-17" # We have to put our key in .streamlit/secrets.toml  
API_KEY = st.secrets["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"] 
...
# Microphone via WebRTC, instead of external mic like the script before 
